...
class _SettingsBodyState extends State<SettingsBody>
  ...
  Future<void> _loadPrefs() async {
    ...
    // Read accent from AppProvider (source of truth) so the dot in the
    // settings tile always matches what is actually live in the theme
    final liveAccent = context.read<AppProvider>().accentColorName;
    setState(() {
    ...
    showModalBottomSheet(
      ...
      builder: (_) => _AccentColorSheet(
        ...
        onSelect: (c) {
          ...
          // Drive the live theme change through AppProvider —
          // this rebuilds MaterialApp theme instantly app-wide
          context.read<AppProvider>().setAccentColor(c);
        },
      ),
    );
  }
